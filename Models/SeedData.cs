...
namespace Platform.Models
{
    public class SeedData
    {
        ...
        public SeedData(IServiceScopeFactory serviceScopeFactory, ILogger<SeedData> log)
        {
        ...
        public void SeedDatabase()
        {
            ...
            {
                CalculationContext context = scope.ServiceProvider.GetRequiredService<CalculationContext>();
